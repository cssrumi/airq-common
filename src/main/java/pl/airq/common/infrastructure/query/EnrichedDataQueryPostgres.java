...
public class EnrichedDataQueryPostgres implements EnrichedDataQuery {
    ...
    static final String FIND_ALL_BY_STATION_QUERY = "SELECT * FROM ENRICHED_DATA WHERE STATION = $1";
    static final String FIND_LATEST_BY_STATION_QUERY = FIND_ALL_BY_STATION_QUERY + LATEST_QUERY_PART;
    static final String FIND_ALL_BY_COORDS_QUERY = "SELECT * FROM ENRICHED_DATA WHERE LON = $1 AND LAT = $2";
    static final String FIND_BY_STATION_AND_TIMESTAMP = "SELECT * FROM ENRICHED_DATA WHERE STATION = $1 AND TIMESTAMP = $2";
